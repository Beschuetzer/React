...
const Song = ({song, selectSong, selectedSong}) => {
    const isSelectedSong = JSON.stringify(song) === JSON.stringify(selectedSong) ? 'isSelected' : '';
    console.log('song-item__isSelectedSong =', isSelectedSong);
    return (
        <div className={`song-item ${isSelectedSong}`}>
